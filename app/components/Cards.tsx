...
const Cards = () => {
  ...
  return (
    <div>
        ...
        <h1 className=' text-red-900 font-extrabold text-xl'>OUR ASTROLOGY SERVICES</h1>
        <a href="/view"><button
        ...
        <div className="grid grid-cols-1 m-10 sm:grid-cols-3 grid-rows-3 gap-4 xl:grid-cols-3 xl:grid-rows-3">
        
        {gridData.map((cell) => (
          <div key={cell.id} className="bg-gray-200 rounded-lg">
            {cell.image && (
              <>
                <img
                  src={cell.image}
